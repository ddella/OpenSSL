...
If `n` is the number of digits, in base 10, you have to solve the equation 2<sup>512</sup>=10<sup>n</sup>

512 * log<sub>10</sub>2 = n

>log<sub>10</sub>2≈0.30  
...
If `n` is the number of digits in base 16, you have to solve the equation 2<sup>512</sup>=16<sup>n</sup>

512 * log<sub>16</sub>2 = n

>log<sub>16</sub>2=0.25  
